          ...
          return (
            <div key={p.id} className="relative">
              ...
              <div
                ...
                style={{ top: -3, left: -3, width: 3, height: 3, backgroundColor: 'var(--y2k-navy)' }}
                aria-hidden="true"
              />
              <div
                className="absolute pointer-events-none"
                style={{ top: -3, right: -3, width: 3, height: 3, backgroundColor: 'var(--y2k-navy)' }}
                aria-hidden="true"
              />
              <div
                className="absolute pointer-events-none"
                style={{ bottom: -3, left: -3, width: 3, height: 3, backgroundColor: 'var(--y2k-navy)' }}
                aria-hidden="true"
              />
              <div
                className="absolute pointer-events-none"
                style={{ bottom: -3, right: -3, width: 3, height: 3, backgroundColor: 'var(--y2k-navy)' }}
                aria-hidden="true"
              />
            </div>
          );
